 ...
 * const authority2 = getAuthority( 'https://main-bvxea6i-iogixy7752ace.us.platformsh.site:8080/test/' ); // 'localhost:8080'
 * ```
 *
 ...
 * @example
 * ```js
 * const path1 = getPath( 'https://main-bvxea6i-iogixy7752ace.us.platformsh.site:8080/this/is/a/test?query=true' ); // 'this/is/a/test'
 ...
 * @example
 * ```js
 * const queryString = getQueryString( 'https://main-bvxea6i-iogixy7752ace.us.platformsh.site:8080/this/is/a/test?query=true#fragment' ); // 'query=true'
 * ```
 *
 ...
 * @example
 * ```js
 * const pathAndQueryString1 = getPathAndQueryString( 'https://main-bvxea6i-iogixy7752ace.us.platformsh.site:8080/this/is/a/test?query=true' ); // '/this/is/a/test?query=true'
 ...
 * @example
 * ```js
 * const fragment1 = getFragment( 'https://main-bvxea6i-iogixy7752ace.us.platformsh.site:8080/this/is/a/test?query=true#fragment' ); // '#fragment'
 ...
 * @example
 * ```js
 * const filename1 = getFilename( 'https://main-bvxea6i-iogixy7752ace.us.platformsh.site:8080/this/is/a/test.jpg' ); // 'test.jpg'
